...
The below metrics were deduced from the raw session file:
```
~\.gemini\antigravity\brain\952b5b81-7d28-47f9-bb97-11afcc5c4732\.system_generated\logs\transcript.jsonl
```
